...
export async function queryEthAdressByAccountId(api: ApiPromise, accountId: string): Promise<string> {
  return (await api.query.userProfile.ethAddressByAccountId(accountId)).toString();
}
