...
export async function queryElectronicMedicalRecordByOwnerId(api: ApiPromise, ownerId: string): Promise<ElectronicMedicalRecord[]> {
...
export async function queryElectronicMedicalRecordById(api: ApiPromise, emrId: string): Promise<ElectronicMedicalRecord> {
...
export async function queryElectronicMedicalRecordFileById(api: ApiPromise, fileId: string): Promise<ElectronicMedicalRecordFile> {
